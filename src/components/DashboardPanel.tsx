...
export const DashboardPanel: React.FC<DashboardPanelProps> = React.memo(
  ({ telemetry, systemStatus, locale }) => {
    ...
    // Incident styling
    const incidentBg = telemetry.incident_flag
      ? "var(--bg-danger-mute)"
      : "var(--bg-surface-elevated)";
    const incidentBorder = telemetry.incident_flag
      ? "var(--accent-danger)"
      : "var(--border)";
    const incidentTextColor = telemetry.incident_flag
      ? "var(--accent-danger)"
      : "var(--text-secondary)";
        ...
        >
            ...
            >
              <div
                style={{
                  ...
                  transition:
                    "width var(--transition-normal), background-color var(--transition-normal)",
                }}
              />
            </div>
            <span
          ...
          >
            ...
            >
              ...
              >
                {telemetry.incident_flag
                  ? t("field.incident_active")
                  : t("field.incident_none")}
              </strong>
            </div>
          </div>
        </div>
